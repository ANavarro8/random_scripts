...
my $map_shell="
STAR --runThreadN 16 --genomeDir ~/database/STAR_Niattv7mc --readFilesIn <(zcat $cleandata/$name\_1_trim.fq.gz ) -2 <(zcat $cleandata/$name\_2_trim.fq.gz ) --outSAMstrandField intronMotif --genomeLoad NoSharedMemory &
";
push (@map_shell, $map_shell);
